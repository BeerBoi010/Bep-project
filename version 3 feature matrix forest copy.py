...
# Define the total number of data points in your dataset
total_data_points = 1905

# Calculate the scaling factor to convert time ranges from seconds to measurement points
scaling_factor = total_data_points / annotation3[-1, 1]

# Scale the annotated time ranges to 1905 data points
annotation3_scaled = np.round(annotation3 * scaling_factor).astype(int)
...
annotation = {'drinking_HealthySubject2_Test': annotation2_numbers,
              'drinking_HealthySubject3_Test': annotation3_numbers,
              'drinking_HealthySubject4_Test': annotation4_numbers,
              'drinking_HealthySubject5_Test': annotation5_numbers,
              'drinking_HealthySubject6_Test': annotation6_numbers,
              'drinking_HealthySubject7_Test': annotation7_numbers
              }
...
for start, end, label in annotation3_scaled:
