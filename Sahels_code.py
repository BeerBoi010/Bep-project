...
wdir='C:/Users/sahel/Desktop/TowardATHomeRehab_Python'
os.chdir(wdir)
data = np.load('data_Preprocessed.npy', allow_pickle='True').item()
Gyro_signal= np.load('Gyro_signal.npy',allow_pickle='TRUE').item()
Acc_signal = np.load('Acc_signal.npy',allow_pickle='TRUE').item()
