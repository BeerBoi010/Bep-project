...
ovr_clf = OneVsRestClassifier(SVC(C=10, gamma=0.001, kernel="rbf",random_state=42))
...
ova_clf_lda = OneVsRestClassifier(SVC(C=10, gamma=0.001, kernel="rbf", random_state=42))
ova_clf_lda.fit(X_train_lda, y_train)
y_test_pred_lda = ova_clf_lda.predict(X_test_lda)

ova_clf_pca = OneVsRestClassifier(SVC(C=10, gamma=0.001, kernel="rbf", random_state=42))
