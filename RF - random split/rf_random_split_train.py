...
clf = RandomForestClassifier(n_estimators=150,min_samples_leaf=1,max_depth=10, random_state=42)
...
clf_lda = RandomForestClassifier(n_estimators=150,min_samples_leaf=1,max_depth=10, random_state=42)
clf_lda.fit(X_train_lda, y_train)
y_test_pred_lda = clf_lda.predict(X_test_lda)

clf_pca = RandomForestClassifier(n_estimators=150,min_samples_leaf=1,max_depth=10, random_state=42)
